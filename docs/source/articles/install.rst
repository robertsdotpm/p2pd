...
This automatically installs the required dependencies: ``aionetiface``, ``sidewire``, and ``namebump``.

P2PD also has optional dependencies for running tests or a PNP server. There is no harm in installing them alongside the main package.
