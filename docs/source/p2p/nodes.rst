...
messages back to these handles. Where P2PD really shines is it's the only
...
or pin holed. You can configure whether you want to try to use
UPnP to improve reachability for your node.

UPnP will need to be enabled on a router used for one of your nodes interface(s).
