...
class IPRange():
    ...
    def __add__(self, n):
        ...
        raise NotImplementedError("Add not implemented for that type.")
    ...
    def __sub__(self, n):
        ...
        raise NotImplementedError("Sub not implemented for that type.")
    ...
    def _convert_other(self, other):
        if isinstance(other, (int, bytes, str)):
            ...
            raise NotImplementedError("Compare not implemented for type.")
