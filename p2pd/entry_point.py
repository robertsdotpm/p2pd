...
async def start_p2p_node(port=NODE_PORT, node_id=None, ifs=None, clock_skew=Dec(0), ip=None, pp_executors=False, signal_offsets=None, netifaces=None, conf=NODE_CONF):
