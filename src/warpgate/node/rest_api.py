"""Embedded REST API server exposed by a warpgate node."""
import asyncio
...
class WarpgateServer(RESTD):
    """HTTP REST server exposing Warpgate node functionality over a local loopback interface."""
