"""CLI argument definitions for the warpgate demo."""
import argparse
...
parser.add_argument(
    ...
    required=False,
    help=(
        "Directory path to use to store some of Warpgates data files. "
        "Defaults to user home/warpgate"
    ),
)
parser.add_argument(
    "--disable_upnp",
...
parser.add_argument(
    ...
    action="store_true",
    help=(
        "Strictly verify all four sibling repos (aionetiface, warpgate, "
...
# Bare `python -m warpgate.demo` with no flags runs the interactive menu
